...
const createExtraFilmList = (title) => {
  return (
...
render(filmWrapper, createFilmsList(), `beforeEnd`);
render(filmWrapper, createExtraFilmList(`Top rated`), `beforeEnd`);
render(filmWrapper, createExtraFilmList(`Most commented`), `beforeEnd`);
...
const extraFilms = filmWrapper.querySelectorAll(`.films-list--extra`);
render(extraFilms[1], createFilmsContainer(), `beforeEnd`);
...
render(extraFilms[0], createFilmsContainer(), `beforeEnd`);
